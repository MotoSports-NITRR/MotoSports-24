...
import Ourcar from '../eBaja-FB-essentials/perfomance-info/performance-info';
import Phases from '../eBaja-FB-essentials/phases/phases';
import team from "../eBaja-FB-essentials/team/team.json"
import TeamComp from '../eBaja-FB-essentials/team/domain/domain';
...
function App() {
  ...
  // console.log(typeof(team.frames));
    ...
    <>
      <main className='flex flex-col justify-between items-center bg-modestBrown'>
        <div id='introDiv' className="w-85vw">
          ...
          {/* <Frames /> */}
          <TeamComp {...team} />
          {/* <TeamComp {...team.suspension} heading="Suspension" />
          <TeamComp {...team.steering} heading="Steering" />
          <TeamComp {...team.frames} heading="Frames" />
          <TeamComp {...team.frames} heading="Frames" />
          <TeamComp {...team.frames} heading="Frames" /> */}
