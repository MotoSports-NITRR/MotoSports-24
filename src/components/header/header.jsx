                ...
                <div className="w-85vw box-border">
                    <nav className='flex justify-between items-center min-h-32'>
                        <div className='px-2 py-6 xl:px-10 xl:py-10 flex justify-center items-center'>
                            <a href="/">
                                <h1 className='hidden md:block font-inter text-4xl font-black text-blackbean'>MOTOSPORTS</h1>
                                <h1 className='md:hidden font-inter text-3xl font-black text-blackbean'>MOTO</h1>
                                <h1 className='md:hidden font-inter text-3xl font-black text-blackbean'>SPORTS</h1>
                            </a>
                        </div>
